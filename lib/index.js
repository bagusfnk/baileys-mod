...
╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝   ╚═╝
`));
console.log(chalk.hex("#1E3A8A")("Baileys Modification By Bagus-official"));
console.log(chalk.hex("#1E3A8A")("I Hope You Enjoy Wearing Baileys Bagus"));
